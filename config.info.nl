...
index_cols=Kolommen om te bekijken2,dom-Domein naam,user-Gebruikersnaam,owner-Omschrijving,emailto-Email adres<br>,reseller-Reseller,admins-Extra admins,users-Gebruikers,aliases-Alias<br>,quota-Disk quota,uquota-Quota gebruikt,created-Aanmaak datum
index_fcols=Extra kolommen om te bekijken,2,web-Website,ssl-SSL website,dns-DNS domein,mail-Email<br>,mysql-MySQL,postgres-PostgreSQL,spam-Spam filtering,virus-Virus filtering<br>,webalizer-Webalizer,webmin-Webmin login
...
domains_sort=Sorteer virtuele servers op,1,gebruiker-Eigenaar met subserver lijst,dom-Domein naam,eigenaar-Omschrijving,sub-Domein naam met subserver lijst
...
alias_types=Toegestane alias types,13,1-Adres,2-Adres in file,3-File,4-Programma,5-Auto-antwoord,6-Filter,7-Andere gebruiker mailbox,8-Zelfde mailbox in domein,9-Afketsen,10-Gebruikers mailbox,11-Verwijder,Auto-antwoord file,13-Iedereen
...
show_tabs=Categorie&#235;n van Webmin modules op hoofd pagina?,1,1-Ja,0-Nee
...
append=Inclusief domein naam in gebruikersnamen?,1,1-Altijd,0-Alleen om een clash te voorkomen
...
passwd_chars=Karakters voor random wachtwoorden,3,Standaard (A-Z&#44; a-z&#44; 0-9)
...
output_command=Output van opdrachten die vooraf of achteraf altijd laten zien?,1,1-Ja,0-Alleen bij falen
...
trash_folder=Prullenbak folder naam voor nieuwe mailboxen,10,*-Niet aanmaken,trash-prullenbak,Trash-Prullenbak,Andere naam
...
spam_white=Standaard spam witten-lijst optie,1,1-Aangezet,0-Uitgeschakeld
...
ham_trap_white=Afzenders toevoegen van Niet-spam versturen naar <tt>hamtrap</tt> en naar de wittenlijst?,1,2-Globaal,1-Domein niveau,0-Nee
...
collect_notemp=Verzamel HD en CPU temperaturen?,1,0-Ja,1-Nee
...
ldap_mail=Toevoegen van attributen aan LDAP gebruikers?,1,1-Ja gebruik alleen <tt>mail</tt> attributen,2-Ja gebruik <tt>mail</tt> en <tt>mailAlternatiefAdres</tt>,0-Nee
...
secmx_nodns=Toevoegen van DNS MX records voor secundaire mail servers?,1,0-Ja,1-Nee
