...
plan_auto=Zet standaard extra's van het plan wanneer een server gemaakt word?,1,1-Ja,0-Nee
...
usermin_switch=Logins toestaan bij Usermin als mailboxen?,1,1-Ja,0-Nee
...
spam_white=Standaard spam wittelijst optie,1,1-Aangezet,0-Uitgeschakeld
...
ham_trap_white=Afzenders toevoegen van Niet-spam versturen naar <tt>hamtrap</tt> en naar de wittelijst?,1,2-Globaal,1-Domein niveau,0-Nee
...
collect_ifaces=Netwerk interfaces voor data verkeer graph,3,Alle Ethernet
...
backuplog_days=Aantal dagen om backup-log van te bekijken,0,5
...
secmx_nodns=Toevoeg van DNS MX records voor secundaire mail servers?,1,0-Ja,1-Nee
